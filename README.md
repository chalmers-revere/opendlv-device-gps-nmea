...
```
docker run --init --rm --net=host chalmersrevere/opendlv-device-gps-nmea-multi:v0.0.4 opendlv-device-gps-nmea --nmea_ip=10.42.42.112 --nmea_port=9999 --cid=111 --verbose
```
